  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="<?php echo base_url('Dashboard');?>" class="brand-link">
        <img src="<?php echo base_url('asset/AdminLTE');?>/dist/img/poltek.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
        style="opacity: .8">
        <span class="brand-text font-weight-light">Ruang Server | PHB</span>
      </a>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('face/form_input_wajah');?>" class="nav-link">
                  <i class="far fa fa-plus-circle nav-icon"></i>
                  <p>Tambah Data</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('face/tabel_wajah');?>" class="nav-link">
                  <i class="far fa fa-list-ul nav-icon"></i>
                  <p>Daftar Data Wajah</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            <a href="<?php echo base_url('Suhu');?>" class="nav-link">
              <i class="nav-icon fa fa-stroopwafel"></i>
              <p>
                Suhu Ruangan
              </p>
            </a>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('Welcome/api');?>" class="nav-link">
                  <i class="far fa fa-fire nav-icon"></i>
                  <p>Api User</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('Welcome/api_wajah');?>" class="nav-link">
                  <i class="far fa fa-fire nav-icon"></i>
                  <p>Api Wajah</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('Welcome/api_suhu');?>" class="nav-link">
                  <i class="far fa fa-fire nav-icon"></i>
                  <p>Api Suhu</p>
                </a>
              </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url('Users/crul');?>" class="nav-link">
                  <i class="far fa fa-code nav-icon"></i>
                  <p>Crul User</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('Face/crul_wajah');?>" class="nav-link">
                  <i class="far fa fa-code nav-icon"></i>
                  <p>Crul Wajah</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('Suhu/crul');?>" class="nav-link">
                  <i class="far fa fa-code nav-icon"></i>
                  <p>Crul Suhu</p>
                </a>
              </li>
          ...
          <li class="nav-header">Pusat Bantuan</li>
