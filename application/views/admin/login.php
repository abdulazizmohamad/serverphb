...
<div class="login-box">
  <div class="login-logo">
    <a href="."><img src="<?php echo base_url('asset/AdminLTE');?>/dist/img/logopoltek.png" style="margin-bottom:10px"></a>
    <br>
    <a href="<?php echo base_url('Login');?>"><b>Admin Server</b>PHB</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
